...
def invoke_start_stop_rds(db_instance_ids, action):
    ...
    for db_instance_id in db_instance_ids:
        ...
        response = lambda_client.invoke(
            FunctionName='##start_stop_rds',  # Replace with your actual Lambda function name
...
def get_name_to_db_mapping():
    response = lambda_client.invoke(
        FunctionName='##rds_names_dependency',  # Replace with the actual Lambda function name
        InvocationType='RequestResponse'
    )
